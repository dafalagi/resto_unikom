<!-- Modal pilih -->
<div class="modal fade" id="modalpilih" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
...
<!-- Modal Dipesan -->
<div class="modal fade" id="modalpesan" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
